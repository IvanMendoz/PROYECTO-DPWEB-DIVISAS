...
<div class="containeer">
            ...
            <div class="menu-button">
                ...
                <div class="dropdown">
                    ...
                    <div class="dropdown-content">
                        ...
                        <a href="./modificar.php" class="">Modificar pais existente <i class="fas fa-edit"></i></a>
	...
	<h1>Listado de paises almacenados</h1> <br><br>
	<?php
			...
			echo "<tr>";
			echo "<th>Id País</th><th>Nombre</th><th></th><th></th>";
			echo "</tr>";
			...
			while ($row=mysqli_fetch_array($runQuery))
				...
				echo "<td>",$row['nombre'],"</td>";
				 ...
				 echo "<td>"."<a href='./eliminar.php?Id_pais=".$row['Id_pais']."'>Eliminar</a>"."</td>";

                 echo "<td>"."<a href='./modificar.php?Id_pais=".$row['Id_pais']."'>Modificar</a>"."</td>";
